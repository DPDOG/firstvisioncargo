			...
			<div class="small-box bg-lightgreen">
				...
				<?php /*} else { */ ?>
					<a href="#" class="small-box-footer">More info <i
							class="fa fa-arrow-circle-right"></i></a>
				--><?php /*} */ ?>
				<a href="<?= base_url('load/view_load_entry'); ?>" class="small-box-footer">More info <i
						class="fa fa-arrow-circle-right"></i></a>
			...
			<div class="small-box bg-yellow">
				...
				<?php /*} else { */ ?>
					<a href="#" class="small-box-footer">More info <i
							class="fa fa-arrow-circle-right"></i></a>
				--><?php /*} */ ?>
				<a href="<?= base_url('shipper/view_shippers'); ?>" class="small-box-footer">More info <i
						class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
			...
			<div class="small-box bg-orange">
				...
				<?php /*} else { */ ?>
					<a href="#" class="small-box-footer">More info <i
							class="fa fa-arrow-circle-right"></i></a>
				--><?php /*} */ ?>
				<a href="<?= base_url('consignee/view_consignee'); ?>" class="small-box-footer">More info <i
						class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
			...
			<div class="small-box bg-lightred">
				...
				<?php /*} else { */ ?>
					<a href="#" class="small-box-footer">More info <i
							class="fa fa-arrow-circle-right"></i></a>
				--><?php /*} */ ?>
				<a href="<?= base_url('driver/view_driver'); ?>" class="small-box-footer">More info <i
						class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
			...
			<div class="small-box bg-mediumred">
				...
				<?php /*} else { */ ?>
					<a href="#" class="small-box-footer">More info <i
							class="fa fa-arrow-circle-right"></i></a>
				--><?php /*} */ ?>
				<a href="<?= base_url('equipment/view_equipment'); ?>" class="small-box-footer">More info <i
						class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
			...
			<div class="small-box bg-darkred">
				...
				<?php /*} else { */ ?>
					<a href="#" class="small-box-footer">More info <i
							class="fa fa-arrow-circle-right"></i></a>
				--><?php /*} */ ?>
				<a href="<?= base_url('dispatch/view_dispatch') ?>" class="small-box-footer">More info <i
						class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
