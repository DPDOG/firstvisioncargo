									...
									if ($results != '') {
										...
										<div class="col-md-6">
											<div class="sels-report">
												<h4 style="margin-bottom: 30px;">Customer
													Name: <?= htmlspecialchars($customer->name); ?></h4>
											</div>
										</div>
										<div class="col-md-6">
											<div class="sels-report">
												<h4 style="margin-bottom: 30px;">
													Date: <?= htmlspecialchars($results[0]->date); ?></h4>
											</div>
										</div>
									<?php } ?>
									<!--<div class="col-md-6">
									...
									<div class="col-md-12">
										<table class="table table-hover">
											...
											<tr>
												...
												<th scope="col">P/L</th>
												<th scope="col">D/L</th>
												<th scope="col">Dispatch Pay</th>
												<th scope="col">Payroll Advance</th>
											</tr>
											</thead>
											<tbody>
											<?php
