                                ...
                                <div class="row ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <table class="table table-bordered text-center">
                                                    <thead>
                                                    <tr>
                                                        <th class="color-gray " colspan="2">Driver Pay Report</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php
                                    ...
                                    <div class="col-md-12 mt-50">
                                        <table class="table table-bordered">
                                            <thead>
                                            <tr>
                                                <th class="color-gray">Payroll</th>
                                            </tr>
                                            <tr>
                                                <th class="color-blue">Line Haules</th>
                                                <th class="empty-border" colspan="3"></th>
                                                <th class="color-yellow" colspan="3">Miles</th>
                                            </tr>
                                            <tr>
                                                <th class="color-blue">Load #</th>
                                                <th class="color-blue">P/L</th>
                                                <th class="color-blue">D/L</th>
                                                <th class="color-blue">Line Haul</th>
                                                <th class="color-yellow">DH</th>
                                                <th class="color-yellow">Loaded</th>
                                                <th class="color-yellow">Per Mile</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            if ($results != '') {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="color-blue"><strong>Totals</strong></td>
                                        ...
                                        if ($results[0]->detention != 0 || $results[0]->layover != 0 || $results[0]->other_charge != 0) {
                                            ...
                                            <div class="col-md-8 mt-50">
                                                <table class="table table-bordered">
                                                    <thead>
                                                    <tr>
                                                        <th class="color-gray">Detentions & Layovers</th>
                                                    </tr>
                                                    <tr>
                                                        <th class="color-green">Load #</th>
                                                        <th class="color-green">Detention</th>
                                                        <th class="color-green">Layover</th>
                                                        <th class="color-green">Other Charges</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="color-green"><strong>Totals</strong></td>
                                        ...
                                        if ($is_expense == 1) {
                                            ...
                                            <div class="col-md-5 mt-50">
                                                <table class="table table-bordered">
                                                    <thead>
                                                    <tr>
                                                        <th class="color-red">Recurring Expenses</th>
                                                    </tr>
                                                    <tr>
                                                        <th>Description</th>
                                                        <th>Amount</th>
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td>Insurance (Liability & Cargo)</td>
                                                        <td>$<?= number_format($driver->insurance_cargo, 2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Insurance (Truck/Trailer PD)</td>
                                                    ...
                                                    <tr>
                                                        <td class="color-red"><strong>Totals</strong></td>
                                    ...
                                    <div class="col-md-8 mt-50">
                                        <table class="table table-bordered">
                                            <thead>
                                            <tr>
                                                <th class="color-red">Other Expenses</th>
                                            </tr>
                                            <tr>
                                                <th>Date</th>
                                                <th>Description</th>
                                    ...
                                    <div class="col-md-8 mt-50">
                                        <table class="table table-bordered">
                                            <thead>
                                            <tr>
                                                <th class="color-green">Summary</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
