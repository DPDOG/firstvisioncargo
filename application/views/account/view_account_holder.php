...
<section class="content-header">
	<h1>
		Account Holders | <a href="<?php echo base_url('account/add_account_holder'); ?>">
			<button class="btn btn-info btn-sm">Add Account Holder</button>
		</a>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">View Account Holders</h3>
				</div>
				<div class="row">
