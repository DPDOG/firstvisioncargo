...
<section class="content-header">
	<h1>
		Drivers | <a href="<?php echo base_url('driver/add_driver'); ?>">
			<button class="btn btn-info btn-sm">Add Driver</button>
		</a>
	</h1>
	<ol class="breadcrumb">
				...
				<div class="box-body" style="overflow-y: scroll">
					<table id="example1" class="table table-bordered table-striped">
						...
						<tr>
							...
							<th>Status</th>
							<th>Notes</th>
							<th>Insurance (Liability & Cargo)</th>
							<th>Insurance (Truck/Trailer PD)</th>
							<th>IFTA Service</th>
