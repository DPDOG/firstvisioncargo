...
<section class="content-header">
	<h1>
		Expenses | <a href="<?php echo base_url('expense/add_expense'); ?>">
			<button class="btn btn-info btn-sm">Add Expense</button>
		</a>
	</h1>
	<ol class="breadcrumb">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					...
					<button type="button" data-toggle="modal" data-target="#exampleModal"
							class="btn btn-danger pull-right btn-sm"><i class="fa fa-upload"></i> Import From CSV
					</button>
				</div>
				<div class="row">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Import Data from CSV File</h5>
			...
			<div class="modal-body">
				...
				<a href="<?=base_url()?>assets/test.csv">Download Sample CSV File</a>
			</div>
